...
test('user reducer should handle UPDATE_NAME', () => {
  expect(
    reducer(INITIAL_STATE, { type: UPDATE_NAME, payload: 'test' })
  ).toEqual({
    ...INITIAL_STATE,
    name: 'test',
  });
...
test('user reducer should handle UPDATE_MENTOR_ROLE', () => {
  expect(
    reducer(INITIAL_STATE, { type: UPDATE_MENTOR_ROLE, payload: true })
  ).toEqual({
    ...INITIAL_STATE,
    mentorSelected: true,
  });
...
test('user reducer should handle UPDATE_MENTEE_ROLE', () => {
  expect(
    reducer(INITIAL_STATE, { type: UPDATE_MENTEE_ROLE, payload: true })
  ).toEqual({
    ...INITIAL_STATE,
    menteeSelected: true,
  });
...
test('user reducer should handle UPDATE_MENTOR_SUMMARY', () => {
  ...
  expect(
    reducer(INITIAL_STATE, { type: UPDATE_MENTOR_SUMMARY, payload: summary })
  ).toEqual({
    ...INITIAL_STATE,
...
test('user reducer should handle UPDATE_MENTEE_SUMMARY', () => {
  ...
  expect(
    reducer(INITIAL_STATE, { type: UPDATE_MENTEE_SUMMARY, payload: summary })
  ).toEqual({
    ...INITIAL_STATE,
...
test('user reducer should handle UPDATE_BIRTHDAY', () => {
  expect(
    reducer(INITIAL_STATE, { type: UPDATE_BIRTHDAY, payload: '01/01/2000' })
  ).toEqual({
    ...INITIAL_STATE,
    birthday: '01/01/2000',
  });
